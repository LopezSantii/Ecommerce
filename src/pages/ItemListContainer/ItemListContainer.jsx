        ...
        loading ? (
            ...
            (<main>
                <div className="container mt-4">
                    <img className="img-fluid d-none d-md-block" src="src/images/baner.webp" alt="banner" />
                    <img className="img-fluid d-block d-md-none w-100" src="src/images/banerMobile.webp" alt="banner mobile" />
                </div>
